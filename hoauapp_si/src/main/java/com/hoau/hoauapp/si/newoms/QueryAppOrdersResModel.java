...
/**
 * <p>queryAppOrdersResModel complex type的 Java 类。
 * 
 * <p>以下模式片段指定包含在此类中的预期内容。
 * 
 * <pre>
 * &lt;complexType name="queryAppOrdersResModel">
 *   &lt;complexContent>
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *       &lt;sequence>
 *         &lt;element name="queryOrderModel" type="{http://service.server.itf.module.obh.hoau.com/}orderModel" maxOccurs="unbounded" minOccurs="0"/>
...
@XmlType(name = "queryAppOrdersResModel", propOrder = {
    "queryOrderModel",
    "result",
    "resultCode",
    "resultInfo"
})
public class QueryAppOrdersResModel {

    @XmlElement(nillable = true)
    protected List<OrderModel> queryOrderModel;
     ...
     * 
     */
    public List<OrderModel> getQueryOrderModel() {
        if (queryOrderModel == null) {
            queryOrderModel = new ArrayList<OrderModel>();
        }
