...
/**
 * <p>queryClaimsInfo complex type的 Java 类。
 * 
...
public class QueryClaimsInfo {
    ...
    /**
     * 获取identificationCardPicFiles属性的值。
     * 
     * @return
     *     possible object is
     *     {@link ClaimsAttachmentInfo }
    ...
    /**
     * 设置identificationCardPicFiles属性的值。
     * 
     * @param value
     *     allowed object is
     *     {@link ClaimsAttachmentInfo }
